                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <select name="paper_size" class="form-select form-select-sm">
                                            <option value="A4"     {{ ($settings->paper_size ?? 'A4') === 'A4'     ? 'selected' : '' }}>A4</option>
                                            <option value="Letter" {{ ($settings->paper_size ?? '') === 'Letter' ? 'selected' : '' }}>Carta (Letter)</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <table style="width:100%;border-collapse:collapse;border:1px solid #000;margin-bottom:6px;">
                                        <tr>
                                            <td style="width:55%;border:1px solid #000;padding:3px 5px;font-size:8px;">
                                                Fecha de Emisión: <strong>{{ now()->day }}</strong> de <strong>{{ now()->translatedFormat('F') }}</strong> de <strong>{{ now()->year }}</strong>
                                            </td>
