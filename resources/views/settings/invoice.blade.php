                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($settings->company_logo)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $settings->company_logo) }}" alt="Logo actual" style="max-height: 80px;">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="invoice_prefix" name="invoice_prefix" 
                                                   value="{{ old('invoice_prefix', $settings->invoice_prefix) }}" required maxlength="10">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="invoice_suffix" name="invoice_suffix" 
                                                   value="{{ old('invoice_suffix', $settings->invoice_suffix) }}" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="invoice_counter" name="invoice_counter" 
                                           value="{{ old('invoice_counter', $settings->invoice_counter) }}" required min="1">
                                </div>

                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="invoice_auto_increment" name="invoice_auto_increment" 
                                               {{ $settings->invoice_auto_increment ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="ticket_prefix" name="ticket_prefix" 
                                                   value="{{ old('ticket_prefix', $settings->ticket_prefix) }}" required maxlength="10">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="ticket_suffix" name="ticket_suffix" 
                                                   value="{{ old('ticket_suffix', $settings->ticket_suffix) }}" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="ticket_counter" name="ticket_counter" 
                                           value="{{ old('ticket_counter', $settings->ticket_counter) }}" required min="1">
                                </div>

                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="ticket_auto_increment" name="ticket_auto_increment" 
                                               {{ $settings->ticket_auto_increment ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="paper_size" name="paper_size" required>
                                        ...
                                        <option value="Letter" {{ $settings->paper_size === 'Letter' ? 'selected' : '' }}>Carta</option>
                                        <option value="Ticket" {{ $settings->paper_size === 'Ticket' ? 'selected' : '' }}>Ticket (80mm)</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="orientation" name="orientation" required>
                                        <option value="portrait" {{ $settings->orientation === 'portrait' ? 'selected' : '' }}>Vertical</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="default_iva_rate" name="default_iva_rate" 
                                           value="{{ old('default_iva_rate', $settings->default_iva_rate) }}" required min="0" max="100" step="0.01">
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="auto_print_tickets" name="auto_print_tickets" 
                                                   {{ $settings->auto_print_tickets ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="auto_print_invoices" name="auto_print_invoices" 
                                                   {{ $settings->auto_print_invoices ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="footer_text" name="footer_text" rows="3" 
                                              placeholder="Texto que aparecerá al final de los documentos">{{ old('footer_text', $settings->footer_text) }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="terms_conditions" name="terms_conditions" rows="4" 
                                              placeholder="Términos y condiciones de la venta">{{ old('terms_conditions', $settings->terms_conditions) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
window.testPrinter = async function(printerName) {
    try {
        const response = await fetch('{{ route("printers.test") }}', {
            method: 'POST',
            headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    const currentSettings = {
        ...
        ticket_printer: '{{ $settings->ticket_printer }}',
    ...
    async function loadPrinters() {
        ...
        try {
            const response = await fetch('{{ route("printers.list") }}');
            const data = await response.json();
