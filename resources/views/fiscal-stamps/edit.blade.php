    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 font-weight-bold mb-0">
                <i class="bi bi-pencil me-2"></i>{{ __('Editar Timbrado Fiscal') }}
            </h2>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('fiscal-stamps.update', $fiscalStamp) }}">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('stamp_number') is-invalid @enderror" 
                                                   id="stamp_number" name="stamp_number" value="{{ old('stamp_number', $fiscalStamp->stamp_number) }}" 
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control @error('valid_from') is-invalid @enderror" 
                                                           id="valid_from" name="valid_from" value="{{ old('valid_from', $fiscalStamp->valid_from->format('Y-m-d')) }}" required>
                                                    @error('valid_from')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control @error('valid_until') is-invalid @enderror" 
                                                           id="valid_until" name="valid_until" value="{{ old('valid_until', $fiscalStamp->valid_until->format('Y-m-d')) }}" required>
                                                    @error('valid_until')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('establishment') is-invalid @enderror" 
                                                           id="establishment" name="establishment" value="{{ old('establishment', $fiscalStamp->establishment) }}" 
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('point_of_sale') is-invalid @enderror" 
                                                           id="point_of_sale" name="point_of_sale" value="{{ old('point_of_sale', $fiscalStamp->point_of_sale) }}" 
                                                           placeholder="001" required maxlength="3" pattern="[0-9]{3}">
                                                    @error('point_of_sale')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                        ...
                                        <div class="alert alert-info mb-0">
                                            ...
                                            <strong>Formato de factura:</strong> <span id="preview-format">{{ $fiscalStamp->establishment }}-{{ $fiscalStamp->point_of_sale }}-0000001</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="current_invoice_number" class="form-label">Número de Factura Actual <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control @error('current_invoice_number') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('current_invoice_number', $fiscalStamp->current_invoice_number) }}" 
                                                           min="0" required>
                                                    @error('current_invoice_number')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                    <small class="form-text text-muted">
                                                        Último número de factura emitido con este timbrado.
                                                    </small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('max_invoice_number') is-invalid @enderror" 
                                                           ...
                                                           value="{{ old('max_invoice_number', $fiscalStamp->max_invoice_number) }}" 
                                                           min="1" required>
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                                   value="1" {{ old('is_active', $fiscalStamp->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="alert alert-warning">
                                    ...
                                    <ul class="mb-0 mt-2">
                                        ...
                                        <li>Tenga cuidado al modificar la numeración de facturas</li>
                                        <li>No reduzca el número actual por debajo de las facturas ya emitidas</li>
                                    </ul>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-check-circle me-1"></i>Actualizar Timbrado
                                    </button>
                                </div>
                            </form>
                        </div>
