                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <p class="text-muted mb-0">
                            Bienvenido {{ Auth::user()->name }}, gestiona tu negocio desde aquí
                        </p>
                    </div>
                    <div class="col-auto">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card dashboard-card text-center">
                        <div class="card-body p-4">
                            ...
                            <h4 class="text-success fw-bold mb-1">₲ {{ number_format($stats['revenue_today'] ?? 0) }}</h4>
                            <p class="text-muted small mb-0">Ingresos Hoy</p>
                            <small class="text-success">{{ $stats['total_sales_today'] ?? 0 }} ventas</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card dashboard-card text-center">
                        <div class="card-body p-4">
                            ...
                            <h4 class="text-primary fw-bold mb-1">{{ $stats['total_invoices'] ?? 0 }}</h4>
                            <p class="text-muted small mb-0">Total Facturas</p>
                            <small class="text-info">₲ {{ number_format($stats['revenue_month'] ?? 0) }} este mes</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card dashboard-card text-center">
                        <div class="card-body p-4">
                            ...
                            <h4 class="text-warning fw-bold mb-1">{{ $stats['active_products'] ?? 0 }}</h4>
                            <p class="text-muted small mb-0">Productos Activos</p>
                            @if(($stats['low_stock_products'] ?? 0) > 0)
                                <small class="text-danger">{{ $stats['low_stock_products'] }} con stock bajo</small>
                            @else
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card dashboard-card text-center">
                        <div class="card-body p-4">
                            ...
                            <h4 class="text-info fw-bold mb-1">{{ $stats['available_fiscal_stamps'] ?? 0 }}</h4>
                    ...
                    <div class="card dashboard-card">
                        ...
                        <div class="card-body p-4">
                            <div class="row g-4">
                                ...
                                <!-- Timbres Fiscales -->
                                <div class="col-lg-3 col-md-6">
                                    <a href="{{ route('fiscal-stamps.index') }}" class="text-decoration-none">
                                        <div class="card module-card h-100">
                                            <div class="card-body text-center p-4">
                                                <div class="icon-wrapper bg-gradient-danger mx-auto mb-3">
                                                    <i class="bi bi-award"></i>
                ...
                <div class="col-lg-6">
                    <div class="card dashboard-card h-100">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('products.index') }}" class="btn btn-sm btn-outline-warning">Ver Todos</a>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            @if(isset($recentSales) && $recentSales->count() > 0)
                                @foreach($recentSales as $sale)
                                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                        <div>
                                            <strong class="text-dark">Venta #{{ $sale->id }}</strong>
                                            <br>
                                            <small class="text-muted">
                                                {{ $sale->created_at->format('d/m/Y H:i') }} - {{ $sale->user->name ?? 'N/A' }}
                                            </small>
                                        </div>
                                        <span class="badge bg-success">₲ {{ number_format($sale->total_amount) }}</span>
                                    </div>
                                @endforeach
                            @else
                                <div class="text-center text-muted py-4">
