                    ...
                    <div class="col-md-3">
                        <div class="card bg-success text-white">
                            <div class="card-body text-center">
                                ...
                                <h3 class="mb-0"><?php echo e($movements->where('type', 'in')->count() + $movements->where('type', 'purchase')->count()); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-danger text-white">
                            <div class="card-body text-center">
                                ...
                                <h3 class="mb-0"><?php echo e($movements->where('type', 'out')->count() + $movements->where('type', 'sale')->count()); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
