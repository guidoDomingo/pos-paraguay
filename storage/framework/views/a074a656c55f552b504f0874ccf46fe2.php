                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0"><?php echo e($creditStats->total_credit_sales); ?></h2>
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0">₲ <?php echo e(number_format($creditStats->total_collected ?? 0, 0, ',', '.')); ?></h2>
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0">₲ <?php echo e(number_format($creditStats->total_balance_due ?? 0, 0, ',', '.')); ?></h2>
                                </div>
                                <div>
