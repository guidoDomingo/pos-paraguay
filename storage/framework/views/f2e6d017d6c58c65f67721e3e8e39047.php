...
unset($__errorArgs, $__bag); ?>" id="tax_rate" name="tax_rate">
                                                        <option value="10" <?php echo e(old('tax_rate', $product->tax_rate ?? 10) == 10 ? 'selected' : ''); ?>>10%</option>
                                                        <option value="5" <?php echo e(old('tax_rate', $product->tax_rate) == 5 ? 'selected' : ''); ?>>5%</option>
                                                        <option value="0" <?php echo e(old('tax_rate', $product->tax_rate) == 0 ? 'selected' : ''); ?>>Exento</option>
                                                    </select>
