        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <a href="<?php echo e(route('pos.index')); ?>" class="pos-nav-brand me-4">
                        <i class="bi bi-shop"></i>
                        Terminal POS Paraguay
                    </a>
                    <!-- Navigation Menu -->
                    <div class="d-none d-lg-flex align-items-center gap-3">
                        <a href="<?php echo e(route('dashboard')); ?>" class="nav-link text-white-50 hover-white">
                            <i class="bi bi-house-door"></i>
                            Dashboard
                        </a>
                        <a href="<?php echo e(route('pos.index')); ?>" class="nav-link text-white hover-white">
                            <i class="bi bi-cash-register"></i>
                            Terminal POS
                        </a>
                        <a href="<?php echo e(route('products.index')); ?>" class="nav-link text-white-50 hover-white">
                            <i class="bi bi-box-seam"></i>
                            Productos
                        </a>
                        <a href="<?php echo e(route('categories.index')); ?>" class="nav-link text-white-50 hover-white">
                            <i class="bi bi-tags"></i>
                            Categorías
                        </a>
                        <a href="<?php echo e(route('inventory.index')); ?>" class="nav-link text-white-50 hover-white">
                            <i class="bi bi-boxes"></i>
                            Inventario
                        </a>
                        <a href="<?php echo e(route('sales.index')); ?>" class="nav-link text-white-50 hover-white">
                            <i class="bi bi-graph-up"></i>
                            Ventas
                        </a>
                        <a href="<?php echo e(route('settings.invoice')); ?>" class="nav-link text-white-50 hover-white">
                ...
                <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="pos-nav-info">
                        ...
                        <span class="ms-1"><?php echo e(date('d/m/Y H:i')); ?></span>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\laragon\www\bodega-app\resources\views/layouts/pos.blade.php ENDPATH**/ ?>